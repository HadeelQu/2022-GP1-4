...
class _NotificationsScreenState extends State<NotificationsScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    Scaffold(
      ...
      drawer: listView(),
      bottomNavigationBar: const BottomNav(selectedPage:  NotificationsScreen.screenRoute,),
      body: Column(children: [
        Row(
          mainAxisAlignment: MainAxisAlignment.spaceBetween,
          children: [buildSectionTitle(context, "الإشعارات"),
            Padding(
              padding: const EdgeInsets.only(left :18.0),
              child: Container(
                height: 30,
                  child: MyButton2(color: Style.buttonColor_pink, title: "إزالة الكل", onPeressed: (){deleteAllNotifications();})),
            )
          ],
        ),
                            ...
                            Row(
                              ...
                              children: [
                                Padding(
                                 ...
                                 }, icon: Icon(Icons.close,color: Style.brown,))
                            ],),
                            Align(
                           ...
                           ,
                            ...
                            Align(
                              ...
                              child: Container(
                                ...
                                child:
                                notification["type"]!="request_rejected"? MyButton2(
